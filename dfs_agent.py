...
class DFSAgent(PacmanAgent):
    ...
    def _dfs_search(self, grid, start):
        """Perform DFS to find path to nearest dot."""
        stack = [(start, [start])]
        visited = {start}
        ...
        while stack and len(visited) < self.search_depth:
            pos, path = stack.pop()
            y, x = pos
...
if __name__ == "__main__":
    ...
    try:
        print("🎮 Starting Ms. Pacman with DFS Agent...")
