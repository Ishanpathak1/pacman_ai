...
def improvedBreadthFirstSearch(problem):
    """An improved version of BFS with optimizations."""
...
# Add the improved BFS to the list of search functions
ibfs = improvedBreadthFirstSearch
